...
the shapes called calcArea (), which returns the area (double type) of that 
particular shape. (Our program uses many kinds of shapes, such as triangle, 
rectangle and so on.) 
...
public class Shape {
   ...
   // Override  toString() to return the string of Shape name and color, 
    * example: “Shape, color is: RED”
...
The program must demonstrate the creation of one Shape object and print 
it name and color to console. Then add code to invoke calcArea() method 
...
public class Lab_2_7_6 {

	public static void main(String[] args) {
		Shape shape = new Shape("Green");
		System.out.println(shape);
		System.out.println(shape.getClass().getSimpleName() + " area is: " 
		+ shape.calcArea());
	}
